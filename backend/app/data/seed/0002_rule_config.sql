...
('narrative.min_rel_change', '0.01', 'percent', '',
 '指标变动的重要性阈值',
 '相对变动低于该值时视为「未变动」，不进支持/冲突任一边。★ 阈值存在的理由是噪声：宝钢 2019 年毛利率从 10.8791% 走到 10.8350%（动了 0.04 个百分点）曾被判成「叙事与事实相悖」，而它与真正的背离（2018 年 14.99% → 10.88%）在四态表里长得一模一样。取值因行业而异，属会计口径。',
 '比例', '0.01', '0.0', '0.10'),

('narrative.forward_verifies_next_year', '1', 'bool', '',
 '前瞻表述验证下一年',
 'MD&A 前瞻段（经营计划、未来发展讨论）说的是下一年，验证对象因此往后挪一年。置 0 则一律用当年数据验证——那会把尚未到期的计划全部误判为冲突。',
 '', '1', '0', '1');
